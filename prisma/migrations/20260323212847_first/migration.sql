-- CreateEnum
CREATE TYPE "QuestionType" AS ENUM ('SINGLE_CORRECT', 'INTEGER', 'MULTIPLE_CORRECT', 'MATRIX_MATCH');
...
CREATE TABLE "tests" (
    ...
    "enableGraphicalAnalysis" BOOLEAN NOT NULL DEFAULT true,
...
CREATE TABLE "questions" (
    ...
    "partialMarks3" INTEGER NOT NULL DEFAULT 0,
    "partialMarks2" INTEGER NOT NULL DEFAULT 0,
    "partialMarks1" INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE "test_attempts" (
    ...
    "needsResume" BOOLEAN NOT NULL DEFAULT false,
    "resumeRequestedAt" TIMESTAMP(3),
